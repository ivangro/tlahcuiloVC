...
public final class MatrixFunctions {
    ...
    public static void main(String[] args) {
        ...
        /*points.add(new Pair(215, 330));
        points.add(new Pair(183, 281));
        points.add(new Pair(168, 221));
        */
        points.add(new Pair(418, 471));
        points.add(new Pair(341, 418));
        points.add(new Pair(268, 434));
        //points.add(new Pair(-4.1,4));
        /*points.add(new Pair(325, 150));
        points.add(new Pair(375, 150));*/
        /*points.add(new Pair(350, 125))
        points.add(new Pair(350, 175));*/
        
        int degree = 1;
        ArrayList<Double> coefficients = compute_coefficients(points, degree);
        double result_cc = MatrixFunctions.corr_coeff(points, coefficients);
        double result_se = MatrixFunctions.std_error(points, coefficients);
        for (double num : coefficients) {
            System.out.println(num);
        }
        System.out.println("Correlation coef: " + result_cc + "\nStd. error: " + result_se);
    }
